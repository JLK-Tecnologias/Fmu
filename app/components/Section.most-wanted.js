      ...
      <Container>
        ...
        >
          <SwiperSlide className={styles.SwiperSlide}>
            ...
            <a className={styles.button} href="https://wa.me/5513998025801?text=Ol%C3%A1%2C+tudo+bem%3F+Queria+saber+mais+sobre+o+curso+de+Administração." target="_blank">
              INSCREVA-SE
            </a>
          </SwiperSlide>
          <SwiperSlide className={styles.SwiperSlide}>
            ...
            <a className={styles.button} href="https://wa.me/5513998025801?text=Ol%C3%A1%2C+tudo+bem%3F+Queria+saber+mais+sobre+o+curso+de+Tecnologia." target="_blank">
              INSCREVA-SE
            </a>
          </SwiperSlide>
          <SwiperSlide className={styles.SwiperSlide}>
            ...
            <a className={styles.button} href="https://wa.me/5513998025801?text=Ol%C3%A1%2C+tudo+bem%3F+Queria+saber+mais+sobre+o+curso+de+Engenharia." target="_blank">
              INSCREVA-SE
            </a>
          </SwiperSlide>
          {/* <SwiperSlide className={styles.SwiperSlide}>
          ...
          <SwiperSlide className={styles.SwiperSlide}>
            ...
            <a className={styles.button} href="https://wa.me/5513998025801?text=Ol%C3%A1%2C+tudo+bem%3F+Queria+saber+mais+sobre+o+curso+de+Pedagogia." target="_blank">
              INSCREVA-SE
            </a>
          </SwiperSlide>
          <SwiperSlide className={styles.SwiperSlide}>
            ...
            <a className={styles.button} href="https://wa.me/5513998025801?text=Ol%C3%A1%2C+tudo+bem%3F+Queria+saber+mais+sobre+o+curso+de+Educação+Física." target="_blank">
              INSCREVA-SE
            </a>
          </SwiperSlide>
        </Swiper>
